...
import { attachRuntimeNpcs } from "./unified-module";
  ...
  "clueBindings": [
    {
      "scene": "特里坎家",
      "clueType": "clue_0",
      "description": "关于加比的失踪，她只知道加比比较叛逆，喜欢出去玩，而且在15岁之后就搬到外面的拖车里住了。本来以为这次失踪只是又一次出去玩，但是没想到已经半个月没有任何消息了。这次刊登委托是因为她不相信当地的警察。如果调查员能够找到她的儿子，她愿意付出很高的委托金。她可以提供给调查员加比的照片，一个打扮很另类独行、身材高大且显得有些憔悴的男子。"
    },
    {
      "scene": "特里坎家",
      "clueType": "clue_1",
      "description": "菲碧平时没有看报纸的习惯，她一直在等待警方的电话，所以她本人不知道关于绑架犯的线索。"
    },
    {
      "scene": "加比的拖车房",
      "clueType": "clue_2",
      "description": "侦查休息区/宣言仔细检查床底：可以找到一个黑袋子，里面是一把手枪与数只弹匣。手枪上的铭文已经被磨平，而且还似乎有些上锈，应该是什么人用的二手货，而且绝对非法。1911手枪：因为磨损故障值为90，伤害为d10+2，具有贯穿属性。"
    },
    {
      "scene": "加比的拖车房",
      "clueType": "clue_3",
      "description": "侦查卫生间/宣言仔细检查洗漱用具：可以找到一些毒品。○粉、海○因，之类的东西，数量不多，但是足够定罪了。"
    },
    {
      "scene": "加比的拖车房",
      "clueType": "clue_4",
      "description": "侦查餐厅/宣言仔细检查餐桌：可以发现在披萨盒下面有一张小卡片，上面似乎是小广告。卡片上的日期大约是2个月前。内容：还在犹豫的男男女女们！还在犹豫什么时候出手享受世界吗！**月**日晚8:00在维森酒吧，享受狂欢！足量酒水免费供应。"
    },
    {
      "scene": "维森酒吧",
      "clueType": "clue_5",
      "description": "使用卡片询问免费饮品的事情：大多数的保安、客人都会选择不回答或者不知道。询问前台则需要给予足够的小费（10$或以上）/成功的取悦才可以得知，之前是一位贵客包下了酒吧，在那天请当地的很多男男女女来到这里狂欢，并且他付了那一夜的所有钱，只是来的人都需要稍微做登记这一点有些奇怪。"
    },
    {
      "scene": "维森酒吧",
      "clueType": "clue_6",
      "description": "进一步的套话是很难办到的。如果调查员想要询问这位贵客的身份，不仅需要付出大量的现金，还要通过一个至少困难成功的社交类技能。如果调查员成功从前台嘴中套出话的话，前台会告诉是艾德里安·埃斯特鲁姆先生。本地调查员可以通过一个成功的灵感得知艾德里安似乎是一个星期前被逮捕的绑架犯。"
    },
    {
      "scene": "维森酒吧",
      "clueType": "clue_7",
    ...
    },
    {
      "scene": "与艾德里安的会面",
      "clueType": "clue_8",
      "description": "如果调查员投掷了成功的精神分析，可以让艾德里安冷静下来。他会认罪，并宣言那一切都是为了救自己的妻女，她们还在危险中需要注意。"
    },
    {
      "scene": "与艾德里安的会面",
      "clueType": "clue_9",
      "description": "如果他冷静了下来，会认罪，并宣言那一切都是为了救自己的妻女。艾德里安会将整个事件的来龙去脉告知调查员：他如何发现米戈联络术，如何召唤米戈，如何被欺骗将妻女变成缸中脑。"
    }
  ]
};
